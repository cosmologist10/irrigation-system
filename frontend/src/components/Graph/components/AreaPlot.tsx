...
const getDataValue = (d: DataType) => d.close;
const bisectDate = bisector<DataType, Date>((d: DataType) => new Date(d.date)).left;
...
export default withTooltip<AreaProps, TooltipData>(
  ({
    ...
    const handleTooltip = useCallback(
      ...
      [dateScale, data, showTooltip, dataValueScale]
    );
        ...
        {tooltipData && (
          <div>
            <TooltipWithBounds
              ...
              style={tooltipStyles}
            >
              {`${getDataValue(tooltipData)}, ${formatDate(getDate(tooltipData))}`}
            </TooltipWithBounds>
          </div>
        )}
      </div>
